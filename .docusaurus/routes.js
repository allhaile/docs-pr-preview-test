...
export default [
  ...
  },
  {
    ...
    component: ComponentCreator('/docs-pr-preview-test/docs', 'a82'),
    routes: [
      {
        path: '/docs-pr-preview-test/docs',
        component: ComponentCreator('/docs-pr-preview-test/docs', '9a2'),
        routes: [
          {
            path: '/docs-pr-preview-test/docs',
            component: ComponentCreator('/docs-pr-preview-test/docs', '6d3'),
            routes: [
              {
                path: '/docs-pr-preview-test/docs/api-tester',
                component: ComponentCreator('/docs-pr-preview-test/docs/api-tester', '7f6'),
                exact: true,
